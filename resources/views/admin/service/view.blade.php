...
@section('content')
    <div class="container mb-5">
        ...
        <div class="row mt-5">
            <!--$data is called from the Service model-->
                ...
                <div class="col-md-4 mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('edit.service',$_data->id)}}" class="btn bg-gradient-info">Edit</a>
                            <a href="{{route('delete.service', $_data->id)}}" class="btn bg-gradient-danger" onclick="return confirm('This data will be deleted permanently')">Delete</a>
                        </div>
                    </div>
                </div>
            @endforeach
