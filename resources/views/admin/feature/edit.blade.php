...
@section('content')
    <div class="container">
      ...
      <!-- Error message -->
        ...
        <!--the form  is for update the information for freature page -->
        <form action="{{route('update.feature',$data->id)}}" method="post" enctype="multipart/form-data" class="card card-body mt-4">
          @csrf
            ...
            <div class="d-flex justify-content-end mt-4">
              <a href="{{route('view.feature')}}"  class="btn bg-gradient-primary m-0">Return</a>
