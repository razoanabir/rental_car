    ...
    <div class="container mb-5">
        <div class="row rounded" style="height: 56px; color: #344767; background: white;">
            ...
            <div class="col-md-12 mt-2">
                <span class="fs-4">All Features Item</span>
                ...
                <div class="col-md-4 mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('edit.feature',$_data->id)}}" class="btn bg-gradient-info">Edit</a>
                            <a href="{{route('delete.feature', $_data->id)}}" class="btn bg-gradient-danger" onclick="return confirm('This data will be deleted permanently')">Delete</a>
                        </div>
                    </div>
                </div>
            @endforeach
